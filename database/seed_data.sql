...
('Stock Engine Block', 'engine', 1, 15000, 3, 0, 2, 0, 0, 'A reliable factory-spec engine block.'),
('Tuned Engine Block', 'engine', 2, 45000, 6, 0, 4, 0, 0, 'Professionally tuned for better power output.'),
('Race-Spec Engine', 'engine', 3, 120000, 10, 0, 6, 1, 0, 'Built specifically for competition.'),
('Elite Powerplant', 'engine', 4, 300000, 15, 1, 8, 2, 0, 'Top-of-the-line racing engine.'),
('Standard Shocks', 'suspension', 1, 8000, 0, 3, 2, 0, 0, 'Basic suspension for all-around handling.'),
('Performance Shocks', 'suspension', 2, 25000, 1, 6, 3, 0, 0, 'Upgraded dampers for better cornering.'),
('Race Suspension Kit', 'suspension', 3, 70000, 2, 10, 5, 1, 5, 'Full adjustable race suspension.'),
('Pro Suspension System', 'suspension', 4, 180000, 3, 15, 7, 2, 10, 'The ultimate in handling tech.'),
('All-Purpose Tires', 'tires', 1, 5000, 1, 2, 1, 0, 0, 'General purpose racing tires.'),
('Grip Compound Tires', 'tires', 2, 15000, 2, 5, 2, 0, 0, 'Soft compound for better grip.'),
('Endurance Tires', 'tires', 3, 40000, 3, 7, 6, 0, 0, 'Long-lasting race-distance tires.'),
('Elite Racing Slicks', 'tires', 4, 100000, 5, 10, 8, 1, 0, 'Maximum grip. The best available.'),
('Basic Spoiler Package', 'aerodynamics', 1, 10000, 1, 1, 0, 3, 0, 'Standard aero for downforce.'),
('Tuned Aero Kit', 'aerodynamics', 2, 30000, 2, 2, 0, 6, 0, 'Wind-tunnel tested improvements.'),
('Race Aero Package', 'aerodynamics', 3, 80000, 3, 3, 1, 10, 5, 'Full race aero kit.'),
('Elite Aero System', 'aerodynamics', 4, 200000, 5, 4, 2, 15, 10, 'CFD-optimized minimal drag setup.'),
('Standard Brake Kit', 'brakes', 1, 6000, 0, 2, 2, 0, 0, 'Factory spec braking system.'),
('Performance Brakes', 'brakes', 2, 18000, 0, 4, 4, 0, 5, 'Upgraded rotors and pads.'),
('Carbon-Ceramic Brakes', 'brakes', 3, 55000, 0, 7, 6, 0, 15, 'Lightweight carbon-ceramic brakes.'),
('Elite Brake System', 'brakes', 4, 140000, 1, 10, 8, 0, 25, 'Maximum fade resistance.'),
('Standard Gearbox', 'transmission', 1, 12000, 2, 1, 2, 0, 0, 'Factory 4-speed manual.'),
('Close-Ratio Gearbox', 'transmission', 2, 35000, 4, 2, 3, 0, 0, 'Tighter ratios for acceleration.'),
('Race Transmission', 'transmission', 3, 90000, 7, 3, 5, 0, 5, 'Purpose-built racing gearbox.'),
('Sequential Racing Trans', 'transmission', 4, 220000, 10, 5, 7, 0, 10, 'Lightning-fast sequential shifting.'),
('Basic Roll Cage', 'safety', 1, 4000, 0, 0, 3, 0, 0, 'Minimum required safety equipment.'),
('Reinforced Cage', 'safety', 2, 12000, 0, 0, 6, 0, -5, 'Stronger cage with extra bars.'),
('Full Safety Package', 'safety', 3, 35000, 0, 0, 10, 0, -10, 'Complete safety system.'),
('Elite Safety Suite', 'safety', 4, 80000, 0, 1, 14, 0, -5, 'Top safety with composite materials.'),
('Basic ECU', 'electronics', 1, 8000, 1, 1, 1, 0, 0, 'Standard engine control unit.'),
('Tuned ECU', 'electronics', 2, 22000, 3, 2, 2, 1, 0, 'Remapped ECU for optimization.'),
('Race Data System', 'electronics', 3, 60000, 5, 4, 3, 2, 0, 'Full telemetry and management.'),
('Elite Electronics Package', 'electronics', 4, 150000, 8, 6, 5, 3, 0, 'Championship-level electronics.');
